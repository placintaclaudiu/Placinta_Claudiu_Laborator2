...
options.UseSqlServer(builder.Configuration.GetConnectionString("Placinta_Claudiu_Laborator2Context") ?? 
throw new InvalidOperationException("Connection string 'Placinta_Claudiu_Laborator2Context' not found.")));
